...
# Fit model
set.seed(123)
# Using 3-fold cross validation method
# to choose number of variables used at each split
# Then using the chosen number of variables to fit model
...
# to choose interaction depth and number of trees 
# Then using the chosen interaction depth and number of trees to fit model
